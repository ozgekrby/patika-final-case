          ...
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-6xl">
                Yeni Sezon Koleksiyonumuzu Keşfedin
              </h1>
              <p className="mt-6 text-lg leading-8 text-zinc-600 sm:max-w-md lg:max-w-none">
                En yeni moda trendleri ve şık tasarımlar ile dolu koleksiyonumuzu keşfedin. Her zevke uygun ürünlerimizle tarzınızı yenileyin ve alışverişin keyfini çıkarın.
              </p>
              <div className="mt-10 flex items-center gap-x-6">
                <Button to={'/kategori/kadin'}>Kolleksiyona göz at</Button>
                <Link to={'/kategori/kadin'} className="text-sm font-semibold leading-6 text-zinc-900">
            ...
            <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              <div
                ...
                <div className="relative">
                  ...
                  />
                  <div
                    className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-zinc-900/10"/>
                </div>
              </div>
