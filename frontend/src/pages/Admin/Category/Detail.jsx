            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:col-span-3 lg:gap-x-8">
              {products.map((product) => (
                <a key={product.id} href={product.href} className="group text-sm">
                  ...
                  <h3 className="mt-4 font-medium text-zinc-900">{product.name}</h3>
                  <p className="italic text-zinc-500">{product.availability}</p>
                  <p className="mt-2 font-medium text-zinc-900">{product.price}</p>
                </a>
              ))}
            </div>
          </div>
