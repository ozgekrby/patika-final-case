...
const navigation = {
  ...
  support: [
    ...
    { name: 'Kılavuzlar', href: '#' },
    { name: 'API Durumu', href: '#' },
  ],
  company: [
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Logo className="ml-[-13px] h-10 w-auto" fill={"#e4e4e7"}/>
            <p className="text-sm leading-6 text-zinc-300">
              Alışverişi daha kolay ve keyifli hale getiriyoruz.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-white">Yasal</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-zinc-400">&copy; 2024 OK Commerce, Her hakkı saklıdır.</p>
        </div>
      </div>
    </footer>
  )
